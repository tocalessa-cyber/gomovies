...
function MovieCard({ media }) {
    ...
    return (
        <Link href={targetUrl} passHref>
            <div className="relative group rounded-xl overflow-hidden shadow-2xl transition-transform duration-300 transform hover:scale-105 hover:shadow-cyan-600/50 cursor-pointer">
                <Image
                    src={posterPath}
                    alt={mediaTitle}
                    width={500}
